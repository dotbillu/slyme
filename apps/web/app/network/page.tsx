                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <p className={`text-sm truncate ${hasUnread ? "font-bold text-white" : "font-medium text-zinc-200"}`}>
                        {room.name}
                      </p>
                      {room.lastMessage && (
                        <span className={`text-[11px] flex-shrink-0 ml-2 ${hasUnread ? "text-green-400" : "text-zinc-600"}`}>
